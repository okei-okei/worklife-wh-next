  ...
  return (
    ...
    >
      <span className="min-w-0">
        <span className="home-link-label block text-[15px] font-black leading-snug md:text-xl">
          {title}
        </span>
        {description ? (
          <span className="home-copy mt-1 block line-clamp-1 text-xs font-medium text-[#666666] md:text-sm">
            {description}
          </span>
        ) : null}
      </span>
