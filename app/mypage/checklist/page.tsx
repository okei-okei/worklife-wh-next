...
const CHECKLIST_ITEMS: ChecklistItemDefinition[] = [
  ...
  {
    key: "flight_ticket_check",
    phase: "渡航前",
    label: "航空券を確認する",
    description: "日本からNZへの航空券、荷物条件、変更・キャンセル条件を確認します。",
    primaryHref: "/partners/flights-transport",
    primaryLabel: "航空券・移動を比較する",
    partnerCategory: "flights-transport",
    urgency: "high",
  },
  {
    key: "arrival_airport_transport",
    phase: "渡航前",
    label: "到着後の空港移動を確認する",
    description: "空港から初日の宿泊先までの移動手段を事前に確認します。",
    primaryHref: "/partners/flights-transport",
    primaryLabel: "航空券・移動を比較する",
    partnerCategory: "flights-transport",
    urgency: "high",
  ...
  {
    key: "language_school_before_departure",
    phase: "渡航前",
    label: "語学学校を検討する",
    description: "英語に不安がある場合は、渡航前に都市、コース、学費を比較します。",
    primaryHref: "/partners/language-school",
    primaryLabel: "語学学校を比較する",
  ...
  {
    key: "domestic_transport_check",
    phase: "到着後すぐ",
    label: "NZ国内移動手段を確認する",
    description: "都市間バス、国内線、配車アプリなど長距離移動の選択肢を確認します。",
    primaryHref: "/partners/flights-transport",
    primaryLabel: "航空券・移動を比較する",
    partnerCategory: "flights-transport",
    urgency: "low",
  ...
  {
    key: "bedding_towels_prepare",
    phase: "到着後すぐ",
    label: "寝具・タオルをそろえる",
    description: "到着初日から使う寝具、タオル、洗面用品を確認します。",
    primaryHref: "/partners/furniture",
    primaryLabel: "生活用品を比較する",
    partnerCategory: "furniture",
    urgency: "high",
  },
  {
    key: "kitchenware_prepare",
    phase: "到着後すぐ",
    label: "キッチン用品をそろえる",
    description: "調理器具、食器、洗剤など、最初に必要なキッチン用品を確認します。",
    primaryHref: "/partners/furniture",
    primaryLabel: "生活用品を比較する",
    partnerCategory: "furniture",
    urgency: "medium",
  ...
  {
    key: "daily_items_prepare",
    phase: "到着後すぐ",
    label: "生活用品をそろえる",
    description: "洗剤、ハンガー、収納用品、雨具などの生活用品を確認します。",
    primaryHref: "/partners/furniture",
    primaryLabel: "生活用品を比較する",
    partnerCategory: "furniture",
    urgency: "medium",
  },
  {
    ...
    phase: "英語・学習",
    label: "英語学習の方法を決める",
    description: "語学学校、独学、仕事探し準備など、自分に合う英語学習方法を確認します。",
    primaryHref: "/partners/language-school",
    primaryLabel: "語学学校を比較する",
    partnerCategory: "language-school",
    urgency: "low",
  ...
  {
    key: "ielts_preparation_check",
    phase: "英語・学習",
    label: "IELTS対策を確認する",
    description: "試験対策が必要な場合は、IELTS対応コースや学習期間を確認します。",
    primaryHref: "/partners/language-school",
    primaryLabel: "語学学校を比較する",
    partnerCategory: "language-school",
    urgency: "low",
  ...
  },
  {
    ...
    primaryLabel: "電気会社を比較する",
    partnerCategory: "electricity",
    urgency: "medium",
  },
  {
    key: "power_start_date_check",
    phase: "生活インフラ",
    label: "入居前に電気の開始日を確認する",
    description: "入居開始日に電気が使えるか、契約開始日と名義を確認します。",
    primaryHref: "/partners/electricity",
    primaryLabel: "電気会社を比較する",
    partnerCategory: "electricity",
    urgency: "high",
  ...
  {
    key: "utilities_payment_check",
    phase: "生活インフラ",
    label: "光熱費の支払い方法を確認する",
    description: "フラットメイトとの分担方法、支払い方法、請求名義を確認します。",
    primaryHref: "/partners/electricity",
    primaryLabel: "電気会社を比較する",
    partnerCategory: "electricity",
    urgency: "medium",
  },
  {
    ...
    primaryLabel: "インターネットを比較する",
    partnerCategory: "internet",
    urgency: "medium",
  },
  {
    key: "internet_available_after_move",
    phase: "生活インフラ",
    label: "入居後に使える通信環境を確認する",
    description:
      "入居直後にWi-Fiが使えるか、開通までの期間や一時的な通信手段を確認します。",
    primaryHref: "/partners/internet",
    primaryLabel: "インターネットを比較する",
    partnerCategory: "internet",
    urgency: "high",
  },
  {
    ...
    phase: "生活インフラ",
    label: "Wi-Fi環境を整える",
    description: "光回線、ワイヤレスブロードバンド、ルーター費用を確認します。",
    primaryHref: "/partners/internet",
    primaryLabel: "インターネットを比較する",
    partnerCategory: "internet",
    urgency: "medium",
  ...
  {
    key: "power_internet_bundle",
    phase: "生活インフラ",
    label: "電気とインターネットのセット契約を確認する",
    description: "電気とネットをまとめる場合の料金、契約期間、解約条件を確認します。",
    primaryHref: "/partners/internet",
    primaryLabel: "インターネットを比較する",
    partnerCategory: "internet",
    urgency: "medium",
  ...
  {
    key: "furniture_appliances_check",
    phase: "生活インフラ",
    label: "家具・家電を確認する",
    description:
      "ベッド、机、冷蔵庫、洗濯機など、物件に含まれるものと自分で用意するものを確認します。",
    primaryHref: "/partners/furniture",
    primaryLabel: "生活用品を比較する",
    partnerCategory: "furniture",
    urgency: "medium",
  ...
  {
    key: "used_furniture_sources_check",
    phase: "生活インフラ",
    label: "中古購入先を確認する",
    description:
      "中古家具や家電を探す場合は、状態、受け渡し場所、支払い方法を確認します。",
    primaryHref: "/partners/furniture",
    primaryLabel: "生活用品を比較する",
    partnerCategory: "furniture",
    urgency: "medium",
