  ...
  return (
    ...
    >
      <HomeImagePlane
        ...
        className="left-0 top-0 h-[48svh] w-full md:left-0 md:top-[10%] md:h-[76svh] md:w-[66vw]"
        imageClassName="object-[54%_50%]"
      />
      <div className="pointer-events-none absolute left-4 top-[49svh] font-serif text-7xl italic leading-none text-[#235347]/10 md:left-[58%] md:top-[14%] md:text-[12rem]">
        02
      </div>
      <div className="mx-auto grid max-w-6xl gap-8 pt-[49svh] md:min-h-[88svh] md:grid-cols-[minmax(0,0.62fr)_minmax(280px,0.38fr)] md:items-center md:pt-0">
